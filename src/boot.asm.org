...
; stage1.asm
; 512 bytes
; setup stack, a20, load next stage
; stage2.asm
; load gdts, setup long mode, 4-level page hierarchy, prep full stack x64, load kernel, jump to kernel
